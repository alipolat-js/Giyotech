...
const GiyotinCamSilinebilirSistem = () => {
  return (
    <div className='w-full h-full min-h-screen flex flex-col justify-between'>
      <HeadLayout
        title={"Silinebilir Giyotin Cam"}
        descripotion={"Giyotin Cam Sisteminde Cam özelliği Isıcam veya Tek cam özelliklerinin tümünü kullanabilmektedir. Katlanır camlar birbirine paralel bağlandığından açılıp kapanma anında herhangi bir sorun veya kayma olmamaktadır. Silinebilir özelliğe sahiptir."}
      />
      ...
      <div className='w-full max-w-7xl mx-auto px-8 pt-24 mt-[78px]'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16'>
          ...
          <div>
            <div className='rounded-2xl overflow-hidden mx-auto cursor-pointer left-0'>
              <Image src={"/Product Images/giyotin-cam-silinebilir.jpg"} alt="Giyotin Cam Silinebilir Sistem" width={400} height={450} layout="responsive" objectFit='cover' />
            </div>
          </div>

          <div>
            <h1 className='font-extrabold font-sans text-3xl md:text-4xl xl:text-5xl text-rose-700 tracking-wide mb-6'>
              Giyotin Cam &#40;Hareketli Küpeşte&#41; Silinebilir Sistem
            </h1>
            <ul>
              <li>
              ...
              <li>
                <p className='mt-3 max-w-5xl mx-auto text-gray-600 text-lg md:text-xl font-serif mb-3'>
                  Sistemimiz silinebilir özelliğe sahiptir.
                </p>
              </li>
            </ul>
          </div>
        ...
        <h1 className='font-extrabold font-sans text-3xl md:text-4xl xl:text-5xl text-gray-500 tracking-wide mb-16 text-center'>
          Giyotin Cam - Silinebilir Sistem İçin
          <span className='text-rose-700 block'>Fiyat Teklifi Alın</span>
        </h1>

        <div className='w-full flex justify-center'>
          <ContactForm defaultSubject={"Giyotin Cam Silinebilir Sistem"} />
        </div>

        <ProductGallery type={"widget"} productName={"Giyotin Cam (Hareketli Küpeşte) Silinebilir Sistem"} dataFuncName={"getGiyotinCamSilinebilirSistems"}/>
      </div>
...
export default GiyotinCamSilinebilirSistem